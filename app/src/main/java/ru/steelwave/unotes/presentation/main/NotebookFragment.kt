...
import ru.steelwave.unotes.databinding.FragmentNotebookBinding


class NotebookFragment : Fragment() {

    private var _binding: FragmentNotebookBinding? = null
    private val binding: FragmentNotebookBinding
    get() = _binding ?: throw RuntimeException("FragmentNotebookBinding == null")
